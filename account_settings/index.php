...
//[ PREPARE PAGE CONTENT ]
	...
	$query = "SELECT * FROM Users WHERE Lib_ID=$lib_id";
...
CONTENT;
	...
	$page_content.=<<<CONTENT
			<fieldset>
				<form id="account_settings" name ="account_settings" method="post" action="save_changes.php" onSubmit="return verify_basic_settings_form();">
  					...
  					<p>
  						...
  						<input name="New_Contact_No" id="New_Contact_No" value="$row[3]" type="text" size="30" />
  					</p>
  					<p>
  						<label>Email Id</label>
  						<input name="New_Email_Id" id="New_Email_Id" value="$row[5]" type="text" size="30" />
  					</p>
  					<p>
  						<label>Hostel*</label>
  						<select name="New_Hostel" id="New_Hostel"> 
  					...
  					<p>
  						<label>Room No*</label>
  						<input name="New_Room_No" id="New_Room_No" value="$row[7]" type="text" size="30" />
  					</p>
  					<p>
  						<label>Postal Address**</label>
  						<textarea name="New_Postal_Address" id="New_Postal_Address" value="$row[8]" rows="5" cols="30" ></textarea>
  					</p>
  					<p>
			...
			<h3><grey>Change Your Password</grey></h3>
			<p>
				Use the respective fields to change your password and click Change Password to make any changes.
			</p>
			<fieldset>
				<form id="change_password" name ="change_password" method="post" action="change_password.php" onSubmit="return verify_new_password_form();">
  					<p>
  						<label>New Password</label>
  						<input name="New_Password" id="New_Password" value="" type="password" size="30" />
  					</p>
  					<p>
  					...
  					<p>
						<input class="resetbutton" type="reset" value="Reset"/>
  						<input class="submitbutton" type="submit" value="Change Password"/>
  					</p>
				</form>
			</fieldset>
			<br>
