...
$page_content=<<<CONTENT
   	<h1><strong><orange>About Us</orange></strong></h1>
    <br>
	
CONTENT;
$page_content=$page_content . file_get_contents("../contents/about_us");
...
$template=str_replace('<li><a href="../about_us"><span>About Us</span></a></li>','<li class="selected"><a href="../about_us"><span>About Us</span></a></li>',$template);
